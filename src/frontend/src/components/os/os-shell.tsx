...
export function OsShell() {
  ...
  const [showOnboarding, setShowOnboarding] = useState(() => !readStoredBoolean(ONBOARDING_STORAGE_KEY));
  ...
  const [showWelcomeBack, setShowWelcomeBack] = useState(() => readStoredBoolean(ONBOARDING_STORAGE_KEY));
      ...
      <div className="flex-1 flex min-h-0">
        ...
        <div className="hidden lg:flex w-64 shrink-0 flex-col gap-3 p-3 border-r border-zinc-800/60 bg-[#0d0d0d]">
          ...
          <div className="text-[10px] font-mono text-zinc-600 leading-relaxed">
            Start with a prompt or run the demo tour to inspect agents, audits, and governance health.
          </div>
