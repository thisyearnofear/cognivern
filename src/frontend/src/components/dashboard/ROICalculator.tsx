  ...
  return (
    <div className="roi-calculator">
      <div className="roi-header">
        ...
        <p>
          Estimate the return on investment from implementing agent solutions
        </p>
          ...
          <div className="calculator-inputs">
            <div className="input-group">
              ...
              <input
                ...
                onChange={(e) =>
                  handleInputChange("humanCost", Number(e.target.value))
                }
                min="0"
              />
            </div>
            <div className="input-group">
              ...
              <input
                ...
                onChange={(e) =>
                  handleInputChange("agentCost", Number(e.target.value))
                }
                min="0"
              />
            </div>
            <div className="input-group">
              ...
              <input
                ...
                onChange={(e) =>
                  handleInputChange("timeSavings", Number(e.target.value))
                }
                min="0"
                max="100"
              />
              <div className="input-hint">
                Percentage of time saved by using agents
              </div>
            </div>
            <div className="input-group">
              ...
              />
              <div className="input-hint">
                Percentage improvement in output quality
              </div>
            </div>
            <div className="input-group">
              ...
              />
              <div className="input-hint">
                Percentage improvement in regulatory compliance
              </div>
            </div>
            ...
            <div className="roi-results">
              ...
              <div className="results-grid">
                ...
                <div className="result-card">
                  ...
                  <div className="result-value">
                    {calculateThreeYearROI().toFixed(0)}%
                  </div>
                ...
                <div className="result-card">
                  ...
                  <div className="result-value">
                    {calculatePaybackPeriod().toFixed(1)} months
                  </div>
              ...
              <div className="savings-breakdown">
                ...
                <div className="breakdown-item">
                  ...
                  <div className="breakdown-value">
                    $
                    {(
                      customValues.humanCost - customValues.agentCost
                    ).toLocaleString()}
                  </div>
                </div>
                <div className="breakdown-item">
                  ...
                  <div className="breakdown-value">
                    $
                    {(
                      (customValues.humanCost * customValues.timeSavings) /
                      100
                    ).toLocaleString()}
                  </div>
                </div>
      ...
      {activeTab === "comparison" && (
        <div className="comparison-container">
          <div className="comparison-header">
            ...
            <p>
              See how agent solutions compare to human workers across key
              metrics
            </p>
          </div>
          ...
          <div className="comparison-summary">
            ...
            <ul>
              <li>
                Agents operate 24/7 without fatigue or performance degradation
              </li>
              <li>
                Agents maintain consistent quality and 99%+ policy compliance
              </li>
              <li>Cost per task decreases as agent deployment scales</li>
              <li>
                Human workers can be reallocated to higher-value strategic tasks
              </li>
              <li>
                Governance framework ensures all agent actions are auditable and
                compliant
              </li>
            </ul>
          </div>
