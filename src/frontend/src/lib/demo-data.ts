...
export const DEMO_POLICIES = [
  {
    ...
    type: "budget",
    description:
      "No single agent may spend more than 10 ETH equivalent in a 24-hour window.",
    status: "active",
    agents: 3,
    violations: 1,
    metadata: {},
  },
  {
    ...
    type: "allowlist",
    description:
      "Agent spends restricted to pre-approved contract addresses and DEXs.",
    status: "active",
    agents: 4,
    violations: 0,
    metadata: {},
  ...
  },
  {
    ...
    description:
      "Encrypted budget enforced on-chain via Fhenix FHE. Agent cannot see caps.",
    status: "active",
    agents: 1,
    violations: 0,
    metadata: {
...
export const DEMO_AUDIT_LOGS = [
  {
    ...
    policyChecks: [
      ...
      {
        policyId: "policy-allow-02",
        result: true,
        reason: "Uniswap V3 is allowlisted",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    actionType: "stake",
    description:
      "Attempted to stake 5.0 ETH into unverified contract 0xbad...cafe",
    ...
    policyChecks: [
      {
        policyId: "policy-allow-02",
        result: false,
        reason: "Contract 0xbad...cafe not in allowlist",
      },
    ],
  },
  {
    ...
    policyChecks: [
      ...
      },
      {
        policyId: "policy-allow-02",
        result: true,
        reason: "Flashbots is allowlisted",
      },
    ],
  },
  {
    ...
    policyChecks: [
      {
        policyId: "policy-fhe-04",
        result: true,
        reason: "FHE evaluation: within encrypted budget",
      },
    ],
  },
  {
    ...
    policyChecks: [
      {
        ...
        reason:
          decision === "approved"
            ? "Within daily limit"
            : "Exceeds daily budget threshold",
      },
    ],
  } as AuditLog;
}
