...
const cspHeader = [
  ...
  "connect-src 'self' https://*.walletconnect.com https://*.walletconnect.org https://*.web3modal.org https://*.reown.com wss://*.walletconnect.com wss://*.walletconnect.org wss://*.reown.com https://*.llamarpc.com https://*.publicnode.com https://rpc.ankr.com https://*.infura.io https://cloudflare-eth.com https://sepolia-rollup.arbitrum.io https://sepolia.base.org https://mainnet.base.org https://base.drpc.org https://eth.merkle.io https://*.merkle.io https://eth.drpc.org https://*.drpc.org https://1rpc.io https://rpc.mevblocker.io https://verify.walletconnect.org https://verify.walletconnect.com https://ipfs.io https://*.ipfs.io https://cloudflare-ipfs.com https://gateway.pinata.cloud https://testrpc.xlayer.tech https://api.calibration.node.glif.io",
