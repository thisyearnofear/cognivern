...
export class TradingHistoryService {
     ...
     */
    calculatePerformance(allHistory = this.history) {
    ...
    calculatePerformanceByPeriod(period) {
        const result = {};
    ...
    generateChartData() {
        ...
        const sortedHistory = [...this.history].sort((a, b) => new Date(a.timestamp).getTime() - new Date(b.timestamp).getTime());
...
//# sourceMappingURL=TradingHistoryService.js.map
