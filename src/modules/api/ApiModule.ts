...
import { apiConfig, ServiceConfig, DependencyHealth } from '../../shared/index.js';
...
export class ApiModule extends BaseService {
  ...
  private apiKeyMiddleware(req: express.Request, res: express.Response, next: express.NextFunction): void {
