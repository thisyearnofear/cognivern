 ...
 *
 * Usage:
 *   npx tsx tooling/scripts/hackathon/evaluate-safety.ts
 *   npx tsx tooling/scripts/hackathon/evaluate-safety.ts --seed 42
 *   npx tsx tooling/scripts/hackathon/evaluate-safety.ts --seed 42 --runs 5
 *
 * Options:
