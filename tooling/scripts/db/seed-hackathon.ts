 ...
 *
 * Usage:
 *   MONGODB_URI=mongodb+srv://... pnpm tsx tooling/scripts/db/seed-hackathon.ts
 *   MONGODB_URI=mongodb://localhost:27017 pnpm tsx tooling/scripts/db/seed-hackathon.ts --reset
 *
