...
if [[ "$ENVIRONMENT" == "production" ]]; then
    sed -i.bak "s/database_id = \"your-production-database-id\"/database_id = \"$DB_ID\"/" wrangler.toml
else
    sed -i.bak "s/database_id = \"your-staging-database-id\"/database_id = \"$DB_ID\"/" wrangler.toml
fi
