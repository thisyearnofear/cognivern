 ...
 *
 * Run: LINEAR_API_KEY=lin_api_... pnpm tsx scripts/hydradb/connectors/linear.ts
 *
...
async function main() {
  ...
  if (!process.env.LINEAR_API_KEY) {
    ...
    console.error("Then run: LINEAR_API_KEY=lin_api_... pnpm tsx scripts/hydradb/connectors/linear.ts");
