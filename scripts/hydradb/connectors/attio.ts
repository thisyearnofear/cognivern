 ...
 *   pnpm tsx scripts/hydradb/connectors/attio.ts
 *
...
async function main() {
  ...
  if (!process.env.ATTIO_API_KEY) {
    ...
    console.error("Then run: ATTIO_API_KEY=fc4... ATTIO_WORKSPACE=myworkspace pnpm tsx scripts/hydradb/connectors/attio.ts");
